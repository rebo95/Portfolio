...
gameCtrl_(GameCtrlInputComponent()), badgeRendererMultiBullet_(BadgeRenderer(game->getResources()->getImageTexture(Resources::Badges), 3, 3, 1,2 , 40, 40, 50, 50)), badgeRendererSuperBullet_(BadgeRenderer(game->getResources()->getImageTexture(Resources::Badges), 3, 3, 0, 0, 40, 40, 50, 50))
{
	this->addRenderComponent(&scoreRenderer_);
	this->addRenderComponent(&livesRenderer_);
	//this->addRenderComponent(&badgeRenderer_);
	////this->addRenderComponent(&badgeRendererMultiBullet_);
	////this->addRenderComponent(&badgeRendererSuperBullet_);
