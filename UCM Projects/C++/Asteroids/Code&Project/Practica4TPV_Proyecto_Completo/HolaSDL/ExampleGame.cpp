...
ExampleGame::ExampleGame() :
		SDLGame("Example Game", _WINDOW_WIDTH_, _WINDOW_HEIGHT_), starTreckBulletsManager_(StarTrekBulletManager(this)),fightersManager_(FightersManager(this, &starTreckBulletsManager_)), asteroidsManager_(AsteroidsManager(this)), 
	collisionManager_ (CollisionManager(this, &starTreckBulletsManager_, &fightersManager_, &asteroidsManager_)), gameManager_(GameManager(this)),
