...
public:
  ...
  void setModelMat(glm::dmat4 const& mMat);

  dmat4 giveModelMat() {return modelMat;}

  void setMaterial(Material const& mt);
  void setTexture(Textures const& tex);
...
public : 
	...
	Esfera(GLdouble radio, GLdouble meridianos, GLdouble paralelos);
	~Esfera();
	virtual void draw();
	virtual void render(glm::dmat4 const& modelViewMat);
protected:
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------EsferaDeLuz--------------------------------------------------------------------------------------------
class EsferaDeLuz : public Esfera {
public:
	EsferaDeLuz(GLdouble radio, GLdouble meridianos, GLdouble paralelos);
	~EsferaDeLuz() {};
	virtual void render(glm::dmat4 const& modelViewMat);
	void renderEsfera1(glm::dmat4 const& modelViewMat);
	void renderEsfera2(glm::dmat4 const& modelViewMat);
	virtual void update(GLuint timeElapsed);
	SpotLight* giveLight();
private:
	GLint Cx = 512;
	...
	Esfera* esfera1;
	Esfera* esfera2;
	Material materialEsfera1;
	Material materialEsfera2;
